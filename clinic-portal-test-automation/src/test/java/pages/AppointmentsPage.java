...
public class AppointmentsPage {
    ...
    public WebElement getPatientByName(String firstName, String lastName) {
        ...
        By patientLocator = By.xpath("//div[@role='option' and contains(.,'" + firstName + "') and contains(.,'" + lastName + "')]");
    ...
    public WebElement getProvider(String provider) {
        WebDriverWait wait = new WebDriverWait(Driver.getDriver(), Duration.ofSeconds(10));
        By providerLocator = By.xpath("//div[@role='option' and contains(.,'" + provider + "')]");
